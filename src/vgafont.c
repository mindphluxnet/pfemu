 ...
 *   - 0x7F is blank.  CP437 puts a house glyph there and neither source font
 *     has it.  It is left empty rather than drawn from memory: a
...
uint8_t vga_font8x16[256*16] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x76, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0x76, 0x00, 0x00, 0x00, 0x00,   /* 0xE0 */
    0x00, 0x00, 0x3C, 0x66, 0x66, 0x66, 0x6C, 0x66, 0x66, 0x66, 0x66, 0xEC, 0x00, 0x00, 0x00, 0x00,   /* 0xE1 */
    0x00, 0x00, 0xFE, 0x66, 0x62, 0x60, 0x60, 0x60, 0x60, 0x60, 0x60, 0xF0, 0x00, 0x00, 0x00, 0x00,   /* 0xE2 */
    0x00, 0x00, 0x00, 0x00, 0x00, 0xFE, 0x6C, 0x6C, 0x6C, 0x6C, 0x6C, 0x66, 0x00, 0x00, 0x00, 0x00,   /* 0xE3 */
    0x00, 0x00, 0xFE, 0xC6, 0x62, 0x30, 0x18, 0x18, 0x30, 0x62, 0xC6, 0xFE, 0x00, 0x00, 0x00, 0x00,   /* 0xE4 */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x7E, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0x78, 0x00, 0x00, 0x00, 0x00,   /* 0xE5 */
    0x00, 0x00, 0x00, 0x00, 0x00, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xF6, 0xC0, 0xC0, 0xC0, 0x00,   /* 0xE6 */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x7E, 0x18, 0x18, 0x18, 0x18, 0x18, 0x0E, 0x00, 0x00, 0x00, 0x00,   /* 0xE7 */
    0x00, 0x00, 0x10, 0x7C, 0xD6, 0xD6, 0xD6, 0xD6, 0xD6, 0x7C, 0x10, 0x10, 0x00, 0x00, 0x00, 0x00,   /* 0xE8 */
    0x00, 0x00, 0x7C, 0xC6, 0xC6, 0xC6, 0xFE, 0xC6, 0xC6, 0xC6, 0xC6, 0x7C, 0x00, 0x00, 0x00, 0x00,   /* 0xE9 */
    0x00, 0x00, 0x7C, 0xC6, 0xC6, 0xC6, 0xC6, 0xC6, 0x6C, 0x6C, 0x6C, 0xEE, 0x00, 0x00, 0x00, 0x00,   /* 0xEA */
    0x00, 0x00, 0x3C, 0x66, 0x30, 0x18, 0x7C, 0xC6, 0xC6, 0xC6, 0xC6, 0x7C, 0x00, 0x00, 0x00, 0x00,   /* 0xEB */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x76, 0xDB, 0xDB, 0x6E, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,   /* 0xEC */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x6C, 0xD6, 0xD6, 0xD6, 0xD6, 0xD6, 0x7C, 0x10, 0x10, 0x10, 0x00,   /* 0xED */
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x3C, 0x3C, 0x18, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,   /* 0xF9 */
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,   /* 0xFA */
    0x00, 0x00, 0x03, 0x03, 0x06, 0x06, 0x06, 0x0C, 0xCC, 0x6C, 0x38, 0x18, 0x00, 0x00, 0x00, 0x00,   /* 0xFB */
...
/* Derived once, before anything renders.  Kept as code rather than a second
 * literal table so the two cannot drift apart. */
void vga_font_init(void){
    int c, y;
    for(c = 0; c < 256; c++)
        for(y = 0; y < 8; y++)
            vga_font8x8[c*8+y] = vga_font8x16[c*16+y*2];
}
...
const uint8_t bios_font8x8[128*8] = {
